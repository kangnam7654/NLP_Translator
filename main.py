...
def main():
    ...
    train_loader = lit_loaders.train_dataloader(batch_size=4, num_workers=8)  # 학습 Data Loader
    valid_loader = lit_loaders.val_dataloader(batch_size=4, num_workers=8)  # 검증 Data Loader
